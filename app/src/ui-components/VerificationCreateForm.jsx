...
export default function VerificationCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setUserApprovalName(initialValues.userApprovalName);
    setIsVerified(initialValues.isVerified);
    setFilePathApproval(initialValues.filePathApproval);
    setBrandName(initialValues.brandName);
    setUserDisapprovalName(initialValues.userDisapprovalName);
    setFilePathDisapproval(initialValues.filePathDisapproval);
    setErrors({});
  };
  const validations = {
    suggestion: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Verification(modelFields));
          if (onSuccess) {
